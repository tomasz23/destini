...
class StoryBrain {
  ...
  bool buttonShouldBeVisible() {
    return _storyData[_storyNumber].nextChoice2 < 98;
  }

  void nextStory(int choiceNumber) {
    choiceNumber == 1
        ? _storyNumber = _storyData[_storyNumber].nextChoice1
        : _storyNumber = _storyData[_storyNumber].nextChoice2;
    if (_storyNumber > 98) restart();
  }
}
